...
CREATE TABLE `t_authority`  (
  ...
  `authority` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `authority_desc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_authority` VALUES (1, 'ROLE_admin', '管理员');
INSERT INTO `t_authority` VALUES (2, 'ROLE_common', '普通用户');

-- ----------------------------
-- Table structure for t_authority_permission
-- ----------------------------
...
CREATE TABLE `t_authority_permission`  (
  ...
  CONSTRAINT `authority_id` FOREIGN KEY (`authority_id`) REFERENCES `t_authority` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `permission_id` FOREIGN KEY (`permission_id`) REFERENCES `t_permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_authority_permission
-- ----------------------------
...
CREATE TABLE `t_user`  (
  ...
  `created` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
INSERT INTO `t_user` VALUES (5, 'test', '$2a$10$4mdAiegQ1HFX142eadSp3e0NdiqrD.nYypu1MDwIFkSYHMGC/8rbW', '1390377170@qq.com', 'Thu Mar 05 17:18:18 CST 2026', 1);
...
CREATE TABLE `t_user_authority`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKn9hdhb0hp1mrjv2booh5ihxs0`(`authority_id` ASC) USING BTREE,
  INDEX `FKehc3tsfp1sgorkplu75a0a1wu`(`user_id` ASC) USING BTREE,
  CONSTRAINT `FKehc3tsfp1sgorkplu75a0a1wu` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKn9hdhb0hp1mrjv2booh5ihxs0` FOREIGN KEY (`authority_id`) REFERENCES `t_authority` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
